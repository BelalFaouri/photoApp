        ...
        <div className="card card-signin my-5">
          <div className="card-body">
            ...
            <form className="form-signin">
              ...
              <div className="form-label-group">
                <input name='email' type="email" id="inputEmail" className="form-control" onChange={this.handleChange} placeholder="Username address" required autoFocus ></input>
              ...
              <button className="btn btn-lg btn-primary btn-block text-uppercase" onClick={this.handleSubmit} type="submit">Sign up</button>
            </form>
          </div>
        </div>
      </div>
